...
PAGE_ACCESS_TOKEN = "EAAkIZBgwqfHEBO22FYxq1w8lm17IoVT0Y6ay5Pei0U9wX9VJYc4hhnSPxGKtYkh5ePZBHVqAXdvxLUxEZBz7hywBTT63jWC0SYX9C43cSZBWtY5WEIjfYnzHe6QYuQRc4gXExMha9c0vkk21iQf187QPT1JidurcBQ6DX7YoQn6MP4qPHoigP83h3JG10W53GgZDZD"
...
def send_message(recipient_id, message_text):
    ...
    print("Message send response:", r.status_code, r.text)
        ...
        if data.get("object") == "page":
            for entry in data.get("entry", []):
                for messaging_event in entry.get("messaging", []):
                    ...
                    response_text = "EchoBot here: " + message_text
